...
//this portion is updated as ,if we input "A,B,C,D" or any other letter in the compiler.it was giving an infinite loop ,so we just fixed it by replacing the functions .
...
int main() {
    ...
    while (inGame) {
        ...
        while (inRoom == 1) {
            ...
            switch (roomChoice) {
                case 1:
                    printf("You find a hidden waterfall.\n");
                    inRoom = 2; 
                    break;
                case 2:
                    printf("You build a small shelter.\n");
                    break;
                case 3:
                    printf("You see smoke from a volcano.\n");
                    break;
                case 4:
                    printf("You collect wild berries.\n");
                    break;
                case 5:
                    inRoom = 0; 
                    break;
        ...
        while (inRoom == 2) {
            ...
            switch (roomChoice) {
                case 1:
                    printf("You find a mysterious artifact.\n");
                    inRoom = 3; 
                    break;
                case 2:
                    printf("The cave lights up revealing ancient drawings.\n");
                    break;
                case 3:
                    printf("Bats flutter overhead.\n");
                    break;
                case 4:
                    inRoom = 1; 
                    break;
        ...
        while (inRoom == 3) {
            ...
            switch (roomChoice) {
                case 1:
                    ...
                    break;
                case 2:
                    printf("You collect shiny obsidian.\n");
                    break;
                case 3:
                    printf("You relax at the warm spring.\n");
                    break;
                case 4:
                    inRoom = 2; 
                    break;
